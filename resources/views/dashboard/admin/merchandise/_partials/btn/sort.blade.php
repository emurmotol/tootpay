<div class="btn-group">
    ...
    <ul class="dropdown-menu sort">
        ...
        <li><a href="{{ Request::fullUrlWithQuery(['sort' => str_slug(trans('sort.highest_price'))]) }}">{{ trans('sort.highest_price') }}</a></li>
        <li><a href="{{ Request::fullUrlWithQuery(['sort' => str_slug(trans('sort.lowest_price'))]) }}">{{ trans('sort.lowest_price') }}</a></li>
    </ul>
</div>
