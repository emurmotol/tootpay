...
class SalesReportController extends Controller
{
    ...
    public function daily(Request $request) {
        if ($request->ajax()) {
            ...
            return (String)view('dashboard.admin.sales_report._partials.daily.index', compact('sales'));
        }
    ...
    public function monthly(Request $request) {
        if ($request->ajax()) {
            ...
            return (String)view('dashboard.admin.sales_report._partials.monthly.index', compact('sales'));
        }
        return StatusResponse::find(17)->name;
    }
